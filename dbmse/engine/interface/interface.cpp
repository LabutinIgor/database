...
LUnionNode::LUnionNode(LAbstractNode* left, LAbstractNode* right) : LAbstractNode(left, right) {
    fieldNames = left->fieldNames;
    fieldTypes = left->fieldTypes;
    fieldOrders = left->fieldOrders;
}
...
LSortNode::LSortNode(LAbstractNode* child, std::string offset1, std::string offset2) : LAbstractNode(child, NULL) {
